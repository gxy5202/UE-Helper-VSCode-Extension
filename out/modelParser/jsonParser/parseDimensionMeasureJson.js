...
const SUGGESTDRAGMSG = {
    DIMENSION: '建议拖拽维度至此处',
    MEASURE: '建议拖拽度量至此处'
};
function getAcceptType(type, msg = '') {
    if (msg === '(维度或度量字段都可以)') {
 ...
 * @param {*} valueStr
 */
function parseDescribeValueString(valueStr) {
    const valueArray = valueStr.split('个');
 ...
 * @returns
 */
function parseDescribeString(targetStr = '', type) {
...
function parseDimensionMeasureJson(json) {
    return json.map((componentConfig) => {
...
exports.default = parseDimensionMeasureJson;
//# sourceMappingURL=parseDimensionMeasureJson.js.map